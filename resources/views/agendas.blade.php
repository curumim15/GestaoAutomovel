        ...
        <div class="container px-5">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                    <li class="nav-item"><a class="nav-link active" href="{{route('agendas')}}">Marcações</a></li>
        ...
        <div class="container px-5">
            ...
            <div class=" rounded-3 py-5 px-4 px-md-5 mb-5">
                <div class="text-center mb-5">
                    ...
                    <h1 class="fw-bolder"style="color:#ffffff">Marcações</h1>
                </div>
                            ...
                            <div class="card-body">
                                ...
                                <form  action ="{{route('agendaPost')}}" method="POST" >
                                 @csrf
                                    ...
                                    <div class="form-group">
                                        <label for="exampleFormControlInput1">Marca do Carro</label>
                                        <input type="text" name= "marca" class="form-control" id="exampleFormControlInput1" placeholder="Marca">
                                    </div>

                                    <div class="form-group">
                                        <label for="exampleFormControlInput1">Modelo do Carro</label>
                                        <input type="text" name= "modelo" class="form-control" id="exampleFormControlInput1" placeholder="Modelo">
                                    </div>
                                ...
                                <div class="text-center mb-5">
                                    <p style="color:#000000">Após submeter a marcação recebera uma mesagem para confirmação e a sua data/hora para entrega do carro </p>
                                </div>
                            </div>
                        </div>
                    </div>
